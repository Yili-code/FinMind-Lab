      ...
      <div className="terms-container">
        ...
        <div className="terms-content">
          <section className="terms-section">
            <h2>1. 接受條款</h2>
            <p>
              使用 FinMind Lab（以下簡稱「本平台」）即表示您同意遵守本使用條款。如不同意，請勿使用本平台。
            </p>
          </section>
          ...
          <section className="terms-section">
            <h2>2. 服務說明</h2>
            <p>
              FinMind Lab 提供金融數據分析與研究工具。我們保留隨時修改、暫停或終止服務的權利。
            </p>
          </section>
          ...
          <section className="terms-section">
            <h2>4. 智慧財產權</h2>
            <p>
              本平台的所有內容均為 FinMind Lab 或其授權方的財產，受著作權法保護。您提交的內容仍為您所有，但您授予我們使用該內容以提供和改善服務的權利。
            </p>
          </section>
